...
function EditAreaLoader(){
	...
	//modify to make it work with zk5
	//t.baseURL="";
	t.baseURL=zk.ajaxURI('/web/js/editarea/ext/edit_area', {au : true});
	//t.suffix="";
	t.template="";
...
EditAreaLoader.prototype ={
	...
	init : function(settings){
		...
		//Peter, save the default setting at each widget.
		//Therefore, we can modify some option and re initialize it afterward
		if(typeof t[s["id"]] =="undefined"){
			t[s["id"]]={};	
		}
	...
	*/	
	...
	//modify to make it work with zk5
	window.editAreaLoader = editAreaLoader;
	window.EditAreaLoader = EditAreaLoader;
